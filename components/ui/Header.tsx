...
//             className="md:hidden inline-flex items-center justify-center rounded-lg border border-gray-200 p-2 text-blue-900 hover:bg-gray-50"
...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile: show ONLY a floating hamburger icon */}
      <div className="md:hidden fixed top-4 right-4 z-[60]">
        <button
          onClick={() => setMobileOpen(true)}
          className="inline-flex items-center justify-center rounded-xl bg-white/95 backdrop-blur border border-gray-200 p-3 shadow-lg text-blue-900 hover:bg-gray-50"
          aria-label="Open menu"
        >
          <HamburgerIcon />
        </button>
      ...
      {/* Mobile Menu (your existing menu, unchanged) */}
      {mobileOpen && (
